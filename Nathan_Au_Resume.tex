...
\begin{document}
    ...
    \vspace{0.4em}
    \begin{adjustwidth}{0.125in}{0in}
        \textbf{Reel Digest} $\vert$ Python, Ollama, SQLite, Telegram Bot API, yt-dlp $\vert$ \href{https://github.com/nathan-au/reel-digest}{\underline{Source Code}} \hfill \textbf{Dec. 2025}\\
