...
\begin{document}
    ...
    \begin{adjustwidth}{0.125in}{0in}
        ...
        \begin{itemize}
            \item Reduced material costs by salvaging 75+ microchips and electronic components from unrepairable circuit boards.
            \item Engaged in the full product repair cycle: testing, debugging, repair, assembly, quality control, while adhering to ESD safety protocols.
    ...
    \begin{adjustwidth}{0.125in}{0in}
        ...
        Messaging-based productivity tool that saves users' time by processing short-form media into concise text summaries.
        \begin{itemize}
            \item Designed an audiovisual media processing pipeline: URL validation, video download (yt-dlp), audio extraction, speech transcription (GSR), LLM-based summarization (Ollama), and data storage (SQLite).
        ...
        Automated document processing system to reduce repetitive tasks for tax accounting workflows.
        \begin{itemize}
    ...
    \vspace{0.4em}
    \begin{adjustwidth}{0.125in}{0in}
        \textbf{Languages}: Python, HTML, CSS, JavaScript, PHP, SQL, Dart, C++, Java\\
        \textbf{Libraries \& Frameworks}: Flutter, Vue.js, FastAPI, SQLite, TailwindCSS, SQLModel, Pandas, Matplotlib, pytest\\
        \textbf{Tools}: Git \& GitHub, Ollama, Firebase, Supabase, Vertex AI, LaTeX, Arduino, SolidWorks
    \end{adjustwidth}
\end{document}