...
\begin{document}
    ...
    \begin{adjustwidth}{0.125in}{0in}
        \textbf{Concordia University} \hfill Montr\'{e}al, QC\\
        Bachelor of Engineering -- Software Engineering, Co-op \hfill 2024 -- 2028 (expected)
        \begin{itemize}
            \item GPA: 3.3/4.0
        \end{itemize}
        \textbf{West Carleton Secondary School} \hfill Ottawa, ON\\
    ...
    \vspace{0.4em}
    \begin{adjustwidth}{0.125in}{0in}
        \textbf{Mobile Application Developer} \hfill Nov. 2024 -- Apr. 2025\\
        ...
        \begin{itemize}
            ...
            \item Applied Agile methodology through 2-week Scrum sprints to prioritize high-impact tasks, develop features iteratively, and incorporate user and mentor feedback. 
            \item Produced the official launch video to highlight core functionality and pitched the app at Flutter Montr\'{e}al and Concordia University to 100+ students and professionals.
            \item Earned team recognition for Best UI/UX, Best Presentation, and 2nd Place Winning Team.
        \end{itemize}
        \textbf{Engineering Intern -- Hardware \& Electronics} \hfill Sep. 2023 -- Feb. 2024\\
        ...
        \begin{itemize}
            ...
            \item Tracked inventory of 1,000+ repair components using barcode-enabled data capture and Excel-driven tracking.
        \end{itemize}
    \end{adjustwidth}

    \section*{\large Projects \hfill \small{More projects: \href{https://nathan-au.github.io/\#projects}{nathan-au.github.io}}}
    \hrule 
    \vspace{0.4em}
    \begin{adjustwidth}{0.125in}{0in}
        \textbf{Reel Digest} $\vert$ Python, Ollama, SQLite, Telegram Bot API, yt-dlp \hfill Dec. 2025\\
        Messaging-based productivity service that processes short-form content and generates concise text summaries. 
        \begin{itemize}
        ...
        \end{itemize}
        \textbf{RPG-Mini} $\vert$ Python, FastAPI, Ollama, SQLite, SQLModel, Pytest, Pytesseract \hfill Oct. 2025\\
        ...
        \end{itemize}
        \textbf{Amicae} $\vert$ Flutter, Dart, Firebase, Vertex AI, flutter\_map, Concordia Open Data API \hfill Apr. 2025\\
    ...
    \begin{adjustwidth}{0.125in}{0in}
        ...
        \textbf{Tools}: Git \& Github, Arduino, Ollama, Firebase, Supabase, Vertex AI, LaTeX, SolidWorks, KiCad
    \end{adjustwidth}
\end{document}